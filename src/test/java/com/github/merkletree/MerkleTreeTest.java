...
public class MerkleTreeTest {
    ...
    public void testSha1TwoChildMerkleTree() {
        ...
        for (int iter = 0; iter < tree.getDepth(); iter++) {
            ...
            case 0:
                ...
                assertEquals("4D3747A82973DEA4C7A3821597973AC11D1705BA", Hasher.hexify(childrenHashes.get(0)));
                assertEquals("4119A08F514FA9A7C72C378BDA793CD54A691E94", Hasher.hexify(childrenHashes.get(1)));
                break;
            case 1:
                ...
                assertEquals("DB5013029EC94CEE543B31A04F9DE19FE57B728F", Hasher.hexify(childrenHashes.get(0)));
                assertEquals("F9987AF47E9CE5B5FC4B912EAFE459988E753966", Hasher.hexify(childrenHashes.get(1)));

                childrenHashes = tree.getChildrenHashesOfHash(iter, hashes.get(1));
                assertEquals("F4796EAAE7A7143B76B31203901D410479641D13", Hasher.hexify(childrenHashes.get(0)));
                assertEquals("2DE7E90067600D00BC9B24A269390EE0F3BD5BCF", Hasher.hexify(childrenHashes.get(1)));
                break;
            case 2:
    ...
    public void testDiffSha1TwoChildIdenticalMerkleTrees() {
        ...
        MerkleTree tree1 = new MerkleTree(HashingScheme.SHA1, BranchingFactor.TWO, source);
        tree1.printTree();

        MerkleTree tree2 = new MerkleTree(HashingScheme.SHA1, BranchingFactor.TWO, source);
        tree2.printTree();
    ...
    public void testDiffSha1TwoChildNonIdenticalMerkleTrees() {
        ...
        MerkleTree tree1 = new MerkleTree(HashingScheme.SHA1, BranchingFactor.TWO, source1);
        tree1.printTree();
        ...
        MerkleTree tree2 = new MerkleTree(HashingScheme.SHA1, BranchingFactor.TWO, source2);
        tree2.printTree();
